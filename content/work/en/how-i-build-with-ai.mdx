...
summary: A custom Claude Code framework at IOHK with 7 specialized agents, 4 MCP servers, and automated PR review in the loop, documented in a public PROMPT_HISTORY.md.
