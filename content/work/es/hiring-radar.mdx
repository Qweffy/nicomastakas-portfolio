...
- MRR 0.74 vs 0.28 semántica vs 0.14 exact, medido sobre un gold set incluido en el repo — reproducible.
- Más allá del search: un matcher con agente — loop de tool-use acotado, memoria entre corridas y un servidor MCP.

![hiring-radar — el dashboard Radar: live scope, métricas del mes y la última corrida del agente](/images/hiring-radar/dashboard.png)
